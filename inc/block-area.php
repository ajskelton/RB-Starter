...
class RB_Block_Area {
	...
	/**
	 * Class Instance.
	 * @return RB_Block_Area
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof RB_Block_Area ) ) {
			self::$instance = new RB_Block_Area();
 ...
 * @return object
 */
function rb_block_area() {
	return RB_Block_Area::instance();
}
